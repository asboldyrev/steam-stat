    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
        ...
        <aside class="fixed top-0 left-0 h-full w-64 border-r border-steam bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl z-40">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <router-link to="/" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400" active-class="bg-steam-gradient text-white hover:bg-steam-gradient/90" exact>
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                        <span>{{ t('layout.menu.dashboard') }}</span>
                    </router-link>
                    <router-link to="/library" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-smooth hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400" active-class="bg-steam-gradient text-white hover:bg-steam-gradient/90">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <header class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button @click="toggleTheme" class="p-2.5 bg-white dark:bg-gray-800 border border-steam rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-smooth" :title="isDark ? 'Switch to light theme' : 'Switch to dark theme'">
                        ...
                        <button @click="toggleLocale" class="px-4 py-2.5 bg-white dark:bg-gray-800 border border-steam rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-smooth font-medium text-gray-700 dark:text-gray-300" :title="locale === 'en' ? 'Switch to Russian' : 'Switch to English'">
                            {{ locale === 'en' ? 'RU' : 'EN' }}
                        </button>
                    </div>
                </div>
