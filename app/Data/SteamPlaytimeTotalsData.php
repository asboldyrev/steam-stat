...
final readonly class SteamPlaytimeTotalsData implements JsonSerializable
{
    ...
    public static function fromGames(Collection $games)
    {
        $totalMinutes = 0;
        $windowsMinutes = 0;
        $linuxMinutes = 0;
        ...
        return new SteamPlaytimeTotalsData(
